var ye_dialog = {
    ...
    init: function(isladding/*锁定窗口时不显示loading图片，如参数为ture*/){
        ...
        if(isladding){
        var a = '<div id="ye_dialog_overlay"></div><div style="position:absolute;z-index:9999;right:50%;margin-right:-0px;top:0px; _margin-top:50px;_bottom:auto;_top:expression(eval(document.documentElement.scrollTop));"><div id="ye_dialog_window"><a id="ye_dialog_close" href="#" title="\u5173\u95ed"></a><div id="ye_dialog_title">\u8bf7\u7a0d\u5019...</div><div id="ye_dialog_body"></div></div></div>';
        }else{//默认锁定窗口时显示loading图片
        var a = '<div id="ye_dialog_overlay"></div><div id="ye_dialog_loading"></div><div style="position:absolute;z-index:9999;right:50%;margin-right:-0px;top:0px;_margin-top:50px;_bottom:auto;_top:expression(eval(document.documentElement.scrollTop));"><div id="ye_dialog_window"><a id="ye_dialog_close" href="#" title="\u5173\u95ed"></a><div id="ye_dialog_title">\u8bf7\u7a0d\u5019...</div><div id="ye_dialog_body"></div></div></div>';
        }
       $("body").append(a);
